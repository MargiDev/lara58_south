                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-area">
                        ...
                        <div class="blog-post-thumbnail">
                            <img src="/img/frontend_img/blog-img/blog3.jpg" alt="">
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            ...
                            <img class="mb-50" src="/img/frontend_img/bg-img/hero3.jpg" alt="">
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                <div class="comment-wrapper d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="/img/frontend_img/blog-img/c-1.jpg" alt="">
                                    </div>
                                    <!-- Comment Content -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        <div class="comment-wrapper d-flex">
                                            <!-- Comment Meta -->
                                            <div class="comment-author">
                                                <img src="/img/frontend_img/blog-img/c-2.jpg" alt="">
                                            </div>
                                            <!-- Comment Content -->
                                            <div class="comment-content">
                                                <div class="comment-meta">
                            ...
                            <li class="single_comment_area">
                                <div class="comment-wrapper d-flex">
                                    <!-- Comment Meta -->
                                    <div class="comment-author">
                                        <img src="/img/frontend_img/blog-img/c-3.jpg" alt="">
                                    </div>
                                    <!-- Comment Content -->
                                    <div class="comment-content">
                                        <div class="comment-meta">
